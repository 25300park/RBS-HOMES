...
export default function BottomNav() {
  ...
  return (
    <nav className="flex md:hidden fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-md border-t border-zinc-200/90 py-2 px-4 shadow-xl z-50 justify-around items-center text-[10px] font-bold text-zinc-600">
