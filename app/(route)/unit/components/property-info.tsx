        ...
        <div className="flex w-full items-center justify-between">
          <div className="flex items-center">
            ...
            <div className="flex flex-col">
              ...
              <p>
                {property.area} sqm · {property.bed === 0 ? "studio" : `${property.bed} rooms`} · {property.bath}{" "}
                baths
              </p>
            </div>
          </div>
        ...
        <div className="flex flex-col max-w-[65%]">
          <div className="flex items-center py-8 border-y">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">{property.admin.email}</p>
            </div>
            {/* 잘로/ 라이센스/ 회사/ 페이스북 정보 */}
          </div>
          ...
          {/* 부동산 주요 정보 */}
          <div className="py-12 space-y-4 border-b">
            ...
            <div className="grid grid-cols-3 text-gray-800 gap-6">
              ...
              <div className="flex flex-col gap-6 p-4 border rounded-lg">
                ...
                <div>
                  ...
                  <p>{property.bed === 0 ? "studio" : `${property.bed} rooms`}</p>
                </div>
              </div>
          ...
          <div className=" space-y-4 py-12 border-b">
            <h3 className="text-xl font-medium text-gray-800">
              Property Details
            </h3>
