...
export default function StepThreeForm() {
  ...
  if (isLoading) {
    return (
      <div className="p-6 mb-10 md:mb-0 md:p-4 bg-white rounded-lg shadow-md max-w-[1140px] mx-auto">
  ...
  return (
    <div className="p-6 mb-10 md:mb-0 md:p-4 bg-white border md:border-none md:shadow-none rounded-lg shadow-md max-w-[1140px] mx-auto">
