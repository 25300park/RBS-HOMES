        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 sm:h-18 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2.5 sm:gap-3">
            ...
            <Link
              ...
              className="hidden md:flex items-center gap-1.5 bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold px-3.5 py-2 rounded-xl shadow-md shadow-blue-600/20 active:scale-98 transition-all"
            >
              Post Property
            </Link>
