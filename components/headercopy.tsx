...
const Header = ({}: HeaderProps): React.ReactNode => {
  ...
  return (
    <header className="h-44">
      <nav
        className={` top-0 w-full transition-all duration-300 border-b bg-white flex flex-col ${
          navbarScrolled ? "h-16 shadow-lg bg-white fixed" : "h-44 bg-transparent"
        } z-50 w-full flex  px-24 mx-auto justify-between`}
      >
