...
const MobileImageGallery = ({
  ...
  return (
    <>
      {/* 메인 캐러셀 */}
      <div className="relative w-full h-[280px] hidden md:block" {...carouselHandlers}>
        {/* 상단 버튼들 */}
      ...
      <Drawer open={isFirstDrawerOpen} onOpenChange={setIsFirstDrawerOpen}>
        <DrawerContent className="h-[100dvh] rounded-none">
          <div className="fixed top-6 w-full flex justify-between items-center px-6">
      ...
      <Drawer open={isSecondDrawerOpen} onOpenChange={setIsSecondDrawerOpen}>
        <DrawerContent 
          {...fullscreenHandlers}
          className="h-[100dvh] flex items-center justify-center bg-black rounded-none"
          hiddenBar
        >
          ...
          <div className="flex items-center justify-center w-full relative">
            ...
            <img
              ...
              className="w-full h-auto max-h-[calc(100vh-120px)] object-contain px-12"
            />
